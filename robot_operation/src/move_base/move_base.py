...
class MoveRobot():
    ...
    def move_robot(self, goal):
        ...
        move_robot.pose_subscriber = rospy.Subscriber('/odom', Odometry, lambda data: self.update_pose_callback(data, move_robot))
        
        # Initialize previous goal pose as None
        next_goal_point = None

        
        path = self.make_service_request([start_x,start_y], end_point)
